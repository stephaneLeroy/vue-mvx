<template>
        ...
        <div v-else class="vue3rdj5__infos">
            ...
            <p class="vue3rdj5__infos-txt">
                If Nothing happen, you migth not have installed the MultiversX Defi Wallet Extension.
            </p>
            <p class="vue3rdj5__infos-txt">
                You can download it <a class="vue3rdj5__infos-link"
                                       href="https://chrome.google.com/webstore/detail/multiversx-defi-wallet/dngmlblcodfobpdpecaadgfbcggfjfnm">here</a>
            </p>
        </div>
</template>
